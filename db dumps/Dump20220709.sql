...
INSERT INTO `user` VALUES (1,'Simo','simo@mail.it','simo','Simone','de Donato'),(2,'Vale','vale@mail.it','vale','Valerio','Donno'),(3,'User','user@mail.it','user','User','User'),(4,'test1','test1@mail.com','test1','test1name','test1surname'),(5,'asdasd','asdasd@asdasd.a','asdasd','asdasd','asdsda'),(6,'asdasdq','asdasd@asdasd.aq','asdasd','asdasd','asdsda'),(7,'lol','lol.lol@mail.com','lol','lol','lol'),(8,'lol2','lol2.lol2.lol@mail.mailmailit','lol','lol','lol');
...
-- Dump completed on 2022-07-09  9:21:08
